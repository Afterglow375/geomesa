...
//import org.locationtech.geomesa.accumulo.iterators.StatsIterator.{HISTOGRAM_SERIES, decodeHistogramMap, jsonToHistogramMap}
...
//
//      val geomesaRHP = new StatsIteratorProcess
