...
class RangeSnap(interval: com.google.common.collect.Range[java.lang.Long], buckets: Int) {

  private val bucketSize: Long = (interval.upperEndpoint - interval.lowerEndpoint) / buckets
